...
def qqplot(filename,
    ...
    ax.plot(logPexpt, logPobsv, linestyle='', marker='o', markersize=1, markeredgewidth=0.5,
            fillstyle='none', color='k', zorder=3, label='DGN-WB') # Change the lengend if needed
#     ax.legend()
